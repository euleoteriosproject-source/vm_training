-- VM Training v1.6.1-R2 grant reconciliation proposal.
-- REVIEW ARTIFACT ONLY: this file is intentionally outside supabase/migrations.
-- It has been simulated locally and MUST NOT be executed in Production without
-- a separate approval and a fresh read-only preflight.
